...
### Le Blog (<http://blog.cedricbonhomme.org/>)
...
### Le dépôt Mercurial (<http://hg.cedricbonhomme.org>)

Il fait office de sauvegarde pour mon [dépôt principal][6] sur bitbucket. Ce qui veut dire que les deux commandes suivantes permettent de récupérer la même chose.

  * hg clone http://hg.cedricbonhomme.org/pyaggr3g470r/
...
Voilà. J'espère que vous bénéficierez aussi des ces changements qui je pense vont dans le bon sens.
 ...
 [2]: http://wordpress.org/extend/plugins/wptouch/
 [3]: http://wiki.cedricbonhomme.org
 [4]: http://www.dokuwiki.org
 [5]: http://wiki.cedricbonhomme.org/doku.php/start?do=index
 [6]: http://bitbucket.org/cedricbonhomme
